...
class PDF extends TemplatePDF {
    ...
    // ✅ Checkbox with a real drawn ✓ mark
    function Checkbox($label, $checked = false, $w = 63, $h = 7) {
        ...
        if ($checked) {
            ...
            $this->Line($x + 2.2, $y + 3.5, $x + 3, $y + 4.8); // left slant
            $this->Line($x + 3, $y + 4.8, $x + 4.8, $y + 2);   // right slant
        }
...
$pdf->FancyRow(
    [
        ...
        "ID No.",
        "Username\n(This field is for account modification and deletion request only)",
        "Position/\nDesignation",
        "Employment\nStatus",
